...
| ------------ | --------------------------------- | ------------------------- | ---- | ------------------- | ---------- | ---------- |
| FLOW-TRACKER | 70000 | 30000 | - | 1 | Ethernet51/1<br>Ethernet52/1<br>Ethernet55/1<br>Port-Channel491<br>Port-Channel1 | - |
...
| --------- | --------------- | ------------ | --------- |
| S1_BRDR | Vlan4094 | 10.251.1.9 | Port-Channel491 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_s1-wifi-gw1_Ethernet1 | *trunk | *21,100-103 | *- | *- | 1 |
| Ethernet2 | L2_s1-wifi-gw2_Ethernet1 | *trunk | *21,100-103 | *- | *- | 1 |
| Ethernet49/1 | MLAG_s1-brdr2_Ethernet49/1 | *trunk | *- | *- | *MLAG | 491 |
| Ethernet50/1 | MLAG_s1-brdr2_Ethernet50/1 | *trunk | *- | *- | *MLAG | 491 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet51/1 | P2P_s1-spine1_Ethernet31/1 | - | 172.16.1.17/31 | default | 9200 | False | - | - |
| Ethernet52/1 | P2P_s1-spine2_Ethernet31/1 | - | 172.16.1.19/31 | default | 9200 | False | - | - |
| Ethernet55/1 | P2P_s2-brdr1_Ethernet55/1 | - | 172.16.255.0/31 | default | 9200 | False | - | - |
...
!
interface Ethernet1
   description L2_s1-wifi-gw1_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_s1-wifi-gw2_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet49/1
   description MLAG_s1-brdr2_Ethernet49/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet50/1
   description MLAG_s1-brdr2_Ethernet50/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet51/1
   description P2P_s1-spine1_Ethernet31/1
   no shutdown
   mtu 9200
   no switchport
...
interface Ethernet52/1
   description P2P_s1-spine2_Ethernet31/1
   no shutdown
   mtu 9200
   no switchport
   flow tracker sampled FLOW-TRACKER
...
interface Ethernet55/1
   description P2P_s2-brdr1_Ethernet55/1
   no shutdown
   mtu 9200
   no switchport
   flow tracker sampled FLOW-TRACKER
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | L2_S1_WIFI_GW_Port-Channel1 | trunk | 21,100-103 | - | - | - | - | 1 | - |
| Port-Channel491 | MLAG_s1-brdr2_Port-Channel491 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1
   description L2_S1_WIFI_GW_Port-Channel1
   no shutdown
...
interface Port-Channel491
   description MLAG_s1-brdr2_Port-Channel491
   no shutdown
   switchport mode trunk
...
| --------- | ----------- | --- | ---- | -------- |
| Vlan10 | WIFI-AP-MGMT | PROD | - | False |
| Vlan20 | IoT | PROD | - | False |
| Vlan21 | WIFI-GW-Transit | PROD | - | False |
| Vlan100 | S1-WIFI-USER-1 | PROD | - | False |
| Vlan101 | S1-WIFI-USER-2 | PROD | - | False |
| Vlan102 | S1-WIFI-USER-3 | PROD | - | False |
| Vlan103 | S1-WIFI-USER-4 | PROD | - | False |
...
| Vlan21 |  PROD  |  -  |  10.21.21.1/24  |  -  |  -  |  -  |
| Vlan100 |  PROD  |  -  |  10.100.0.1/22  |  -  |  -  |  -  |
| Vlan101 |  PROD  |  -  |  10.100.4.1/22  |  -  |  -  |  -  |
| Vlan102 |  PROD  |  -  |  10.100.8.1/22  |  -  |  -  |  -  |
| Vlan103 |  PROD  |  -  |  10.100.12.1/22  |  -  |  -  |  -  |
| Vlan3009 |  PROD  |  10.252.1.8/31  |  -  |  -  |  -  |  -  |
...
!
interface Vlan100
   description S1-WIFI-USER-1
   no shutdown
   vrf PROD
   ip address virtual 10.100.0.1/22
!
interface Vlan101
   description S1-WIFI-USER-2
   no shutdown
   vrf PROD
   ip address virtual 10.100.4.1/22
!
interface Vlan102
   description S1-WIFI-USER-3
   no shutdown
   vrf PROD
   ip address virtual 10.100.8.1/22
!
interface Vlan103
   description S1-WIFI-USER-4
   no shutdown
   vrf PROD
   ip address virtual 10.100.12.1/22
!
interface Vlan3009
...
| PROD | 10.255.255.1/32 | 10.21.21.2 | - | 1 | - | WIFI-GW-ANYCAST-VTEP-IP | - |
...
ip route vrf PROD 10.255.255.1/32 10.21.21.2 name WIFI-GW-ANYCAST-VTEP-IP
```
...
| 172.16.1.16 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 172.16.1.18 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 172.16.255.1 | 65203 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
...
| 21 | 10.250.1.7:10021 | 10021:10021<br>remote 10021:10021 | - | - | learned |
| 100 | 10.250.1.7:10100 | 10100:10100<br>remote 10100:10100 | - | - | learned |
| 101 | 10.250.1.7:10101 | 10101:10101<br>remote 10101:10101 | - | - | learned |
| 102 | 10.250.1.7:10102 | 10102:10102<br>remote 10102:10102 | - | - | learned |
| 103 | 10.250.1.7:10103 | 10103:10103<br>remote 10103:10103 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| PROD | 10.250.1.7:10 | connected<br>static | - |
...
router bgp 65103
   ...
   neighbor 172.16.1.16 description s1-spine1_Ethernet31/1
   neighbor 172.16.1.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.1.18 remote-as 65100
   neighbor 172.16.1.18 description s1-spine2_Ethernet31/1
   ...
   vlan 21
      rd 10.250.1.7:10021
      rd evpn domain remote 10.250.1.7:10021
   ...
   vlan 100
      rd 10.250.1.7:10100
      rd evpn domain remote 10.250.1.7:10100
   ...
   vlan 101
      rd 10.250.1.7:10101
      rd evpn domain remote 10.250.1.7:10101
   ...
   vlan 102
      rd 10.250.1.7:10102
      rd evpn domain remote 10.250.1.7:10102
   ...
   vlan 103
      rd 10.250.1.7:10103
      rd evpn domain remote 10.250.1.7:10103
      route-target both 10103:10103
      route-target import export evpn domain remote 10103:10103
      redistribute learned
   !
   address-family evpn
