...
| --------- | --------------- | ------------ | --------- |
| S1_BRDR | Vlan4094 | 10.251.1.8 | Port-Channel491 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_s1-wifi-gw1_Ethernet2 | *trunk | *21,100-103 | *- | *- | 1 |
| Ethernet2 | L2_s1-wifi-gw2_Ethernet2 | *trunk | *21,100-103 | *- | *- | 1 |
| Ethernet49/1 | MLAG_s1-brdr1_Ethernet49/1 | *trunk | *- | *- | *MLAG | 491 |
| Ethernet50/1 | MLAG_s1-brdr1_Ethernet50/1 | *trunk | *- | *- | *MLAG | 491 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet51/1 | P2P_s1-spine1_Ethernet32/1 | - | 172.16.1.21/31 | default | 9200 | False | - | - |
| Ethernet52/1 | P2P_s1-spine2_Ethernet32/1 | - | 172.16.1.23/31 | default | 9200 | False | - | - |
| Ethernet55/1 | P2P_s2-brdr2_Ethernet55/1 | - | 172.16.255.2/31 | default | 9200 | False | - | - |
...
!
interface Ethernet1
   description L2_s1-wifi-gw1_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_s1-wifi-gw2_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet49/1
   description MLAG_s1-brdr1_Ethernet49/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet50/1
   description MLAG_s1-brdr1_Ethernet50/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet51/1
   description P2P_s1-spine1_Ethernet32/1
   no shutdown
   mtu 9200
   no switchport
...
interface Ethernet52/1
   description P2P_s1-spine2_Ethernet32/1
   no shutdown
   mtu 9200
   no switchport
   flow tracker sampled FLOW-TRACKER
...
interface Ethernet55/1
   description P2P_s2-brdr2_Ethernet55/1
   no shutdown
   mtu 9200
   no switchport
   flow tracker sampled FLOW-TRACKER
...
| Port-Channel491 | MLAG_s1-brdr1_Port-Channel491 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel491
   description MLAG_s1-brdr1_Port-Channel491
   no shutdown
   switchport mode trunk
...
| 172.16.1.20 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 172.16.1.22 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 172.16.255.3 | 65203 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
...
| 21 | 10.250.1.8:10021 | 10021:10021<br>remote 10021:10021 | - | - | learned |
| 100 | 10.250.1.8:10100 | 10100:10100<br>remote 10100:10100 | - | - | learned |
| 101 | 10.250.1.8:10101 | 10101:10101<br>remote 10101:10101 | - | - | learned |
| 102 | 10.250.1.8:10102 | 10102:10102<br>remote 10102:10102 | - | - | learned |
| 103 | 10.250.1.8:10103 | 10103:10103<br>remote 10103:10103 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| PROD | 10.250.1.8:10 | connected<br>static | - |
...
router bgp 65103
   ...
   neighbor 172.16.1.20 description s1-spine1_Ethernet32/1
   neighbor 172.16.1.22 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.1.22 remote-as 65100
   neighbor 172.16.1.22 description s1-spine2_Ethernet32/1
   ...
   vlan 21
      rd 10.250.1.8:10021
      rd evpn domain remote 10.250.1.8:10021
   ...
   vlan 100
      rd 10.250.1.8:10100
      rd evpn domain remote 10.250.1.8:10100
   ...
   vlan 101
      rd 10.250.1.8:10101
      rd evpn domain remote 10.250.1.8:10101
   ...
   vlan 102
      rd 10.250.1.8:10102
      rd evpn domain remote 10.250.1.8:10102
   ...
   vlan 103
      rd 10.250.1.8:10103
      rd evpn domain remote 10.250.1.8:10103
