...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | mgmt | 192.168.0.102/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| S1_WIFI_GW | Vlan4094 | 10.251.1.1 | Port-Channel491 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_s1-brdr1_Ethernet1 | *trunk | *21,100-103 | *- | *- | 1 |
| Ethernet2 | L2_s1-brdr2_Ethernet1 | *trunk | *21,100-103 | *- | *- | 1 |
| Ethernet49/1 | MLAG_s1-wifi-gw2_Ethernet49/1 | *trunk | *- | *- | *MLAG | 491 |
| Ethernet50/1 | MLAG_s1-wifi-gw2_Ethernet50/1 | *trunk | *- | *- | *MLAG | 491 |
...
!
interface Ethernet1
   description L2_s1-brdr1_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_s1-brdr2_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet49/1
   description MLAG_s1-wifi-gw2_Ethernet49/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet50/1
   description MLAG_s1-wifi-gw2_Ethernet50/1
   no shutdown
   channel-group 491 mode active
```
...
| Port-Channel491 | MLAG_s1-wifi-gw2_Port-Channel491 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel491
   description MLAG_s1-wifi-gw2_Port-Channel491
   no shutdown
   switchport mode trunk
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan21 |  default  |  10.21.21.4/24  |  -  |  10.21.21.2/24  |  -  |  -  |
